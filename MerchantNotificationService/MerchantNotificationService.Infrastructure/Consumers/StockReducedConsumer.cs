...
public class StockReducedConsumer : IConsumer<StockReducedEvent>
{
    private readonly NotificationDbContext _context;
    private readonly ILogger<StockReducedConsumer> _logger;

    public StockReducedConsumer(NotificationDbContext context, ILogger<StockReducedConsumer> logger)
    {
        _context = context;
        _logger = logger;
    }

    public async Task Consume(ConsumeContext<StockReducedEvent> context)
    {
